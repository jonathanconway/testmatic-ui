...
interface UseImportPopupParams {
  readonly onClose?: VoidFunction;
}

interface UseImportPopupState {
  readonly fileInputError?: string;
}

export function useImportPopup(params: UseImportPopupParams) {
  const [state, setState] = useState<UseImportPopupState>({});
